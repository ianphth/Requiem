...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("記錄") action ShowMenu('history')
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "radio"
                    label _("回滾位置")
                    textbutton _("關閉") action Preference("rollback side", "disable")
                    textbutton _("左方") action Preference("rollback side", "left")
                    textbutton _("右方") action Preference("rollback side", "right")

                vbox:
                    style_prefix "check"
                    label _("略過")
                    textbutton _("未讀") action Preference("skip", "toggle")
